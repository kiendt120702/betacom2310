...
-- Fix infinite recursion in RLS policies by creating simple, non-recursive policies
...
DROP POLICY IF EXISTS "Leaders can read team profiles" ON public.profiles;
DROP POLICY IF EXISTS "Leaders can update team profiles" ON public.profiles;
DROP POLICY IF EXISTS "Admins can insert profiles" ON public.profiles;
DROP POLICY IF EXISTS "Leaders can insert team profiles" ON public.profiles;
DROP POLICY IF EXISTS "Admins can delete profiles" ON public.profiles;
DROP POLICY IF EXISTS "Leaders can delete team profiles" ON public.profiles;

-- Create simple, non-recursive policies using the get_user_role function
