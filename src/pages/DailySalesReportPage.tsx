...
import { useDailyRevenueData, createCompleteDailyData } from "@/hooks/useDailyRevenueData";
...
const DailySalesReportPage = () => {
  ...
  const { data: reports = [], isLoading: reportsLoading } = useDailyRevenueData({ 
    month: selectedMonth, 
  ...
  const filteredReports = useMemo(() => {
    ...
    return createCompleteDailyData(reports, selectedMonth, selectedShop);
