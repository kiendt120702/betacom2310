...
import {
  Card, // Keep Card import for CardTitle/CardDescription if needed, but not for the main container
  CardContent,
  CardDescription,
  CardHeader,
  CardTitle,
...
const TeamManagement: React.FC = () => {
  ...
  return (
    <div className="space-y-6 bg-card rounded-lg shadow-sm border"> {/* Main card-like container */}
      <div className="p-4 sm:p-6"> {/* Inner padding for header and add button */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h2 className="text-2xl md:text-3xl text-foreground flex items-center gap-3">
      ...
      {teams.length === 0 ? (
        <div className="text-center py-12 px-4 border-t border-border"> {/* Add border-t for separation */}
        ...
        <div className="overflow-x-auto border-t border-border"> {/* Add border-t for separation */}
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/50"> {/* Removed border-border here as parent div has it */}
