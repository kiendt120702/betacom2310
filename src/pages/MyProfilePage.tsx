            ...
            <div className="flex flex-col items-center gap-4">
              <div className="text-center space-y-2">
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  ...
                  {userProfile.departments?.name && <Badge variant="outline" className="break-words max-w-full"><Users className="w-3 h-3 mr-1 shrink-0" /><span className="truncate">{userProfile.departments.name}</span></Badge>}
