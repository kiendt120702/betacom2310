...
interface PracticeSubmissionListDialogProps {
  open: boolean;
  onClose: () => void;
  exercise: TrainingExercise | null;
  submissions: PracticeTestSubmissionWithDetails[];
  onGradeSubmission: (submission: PracticeTestSubmissionWithDetails) => void;
}

const PracticeSubmissionListDialog: React.FC<PracticeSubmissionListDialogProps> = ({
  open,
  onClose,
  exercise,
  submissions,
...
export default PracticeSubmissionListDialog;