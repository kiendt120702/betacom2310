...
import { Plus, Edit, Trash2, Library, CheckCircle, AlertCircle, Tag } from "lucide-react";
import StandardManagementLayout from "@/components/management/StandardManagementLayout";
import { useGeneralTraining, useDeleteGeneralTraining, GeneralTrainingExerciseWithTags } from "@/hooks/useGeneralTraining";
...
const GeneralTrainingManagement: React.FC = () => {
  ...
  const [selectedExercise, setSelectedExercise] = useState<GeneralTrainingExerciseWithTags | null>(null);
  ...
  const handleEditExercise = (exercise: GeneralTrainingExerciseWithTags) => {
