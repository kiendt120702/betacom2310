...
const ChangePasswordDialog: React.FC<ChangePasswordDialogProps> = ({ user, open, onOpenChange }) => {
  ...
  const validateForm = () => {
    ...
    if (newPassword.toLowerCase().includes(user?.full_name?.toLowerCase() || '')) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {newPassword && (
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className={`text-xs px-2 py-1 rounded-full ${getStrengthColor(passwordStrength)}`}>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-blue-800">Yêu cầu mật khẩu:</span>
            </div>
          ...
          {passwordErrors.length > 0 && (
            <div className="bg-red-50 border border-red-200 rounded-md p-3">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-red-800">Lỗi xác thực:</span>
              </div>
          ...
          {newPassword && confirmPassword && newPassword === confirmPassword && passwordErrors.length === 0 && (
            <div className="bg-green-50 border border-green-200 rounded-md p-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-green-800">Mật khẩu hợp lệ!</span>
              </div>
            </div>
          )}
          ...
          <DialogFooter>
            ...
            <Button 
              type="submit" 
              disabled={isSubmitting || passwordErrors.length > 0 || !newPassword || !confirmPassword}
            >
              {isSubmitting ? (
                <>
