...
interface SpecialistVideoPreviewDialogProps {
  exercise: SpecialistTrainingExercise;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

const SpecialistVideoPreviewDialog: React.FC<SpecialistVideoPreviewDialogProps> = ({
  exercise,
  open,
  onOpenChange,
}) => {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
        <DialogHeader>
          <DialogTitle className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span>Xem trước video Chuyên viên: {exercise.title}</span>
            </div>
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <span className="font-medium text-muted-foreground">Tên bài tập Chuyên viên:</span>
...
export default SpecialistVideoPreviewDialog;