...
const PreviewVideoPlayer: React.FC<PreviewVideoPlayerProps> = ({
  ...
  // Enhanced loading handlers - Optimized for faster preview
  ...
  const handleLoadedData = useCallback(() => {
    ...
    // Enable preview immediately when enough data is loaded
    setIsLoading(false);
    setVideoLoaded(true);
    setLoadingProgress(100);
  }, []);
  ...
  const handleCanPlay = useCallback(() => {
    ...
    // Fast preview mode - don't wait for full buffer
    setIsLoading(false);
    setVideoLoaded(true);
    setLoadingProgress(100);
  }, []);
  ...
  // Allow free seeking in preview mode
  const handleProgressClick = useCallback((e: React.MouseEvent<HTMLDivElement>) => {
    ...
    // Free seeking allowed in preview mode
