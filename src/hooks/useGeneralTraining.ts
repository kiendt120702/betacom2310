...
export const useCreateGeneralTraining = () => {
  ...
  return useMutation({
    mutationFn: async (data: { title: string; video_url?: string; target_roles?: string[]; target_team_ids?: string[] }) => {
...
export const useUpdateGeneralTraining = () => {
  ...
  return useMutation({
    mutationFn: async (data: { id: string; title?: string; video_url?: string; target_roles?: string[]; target_team_ids?: string[] }) => {
