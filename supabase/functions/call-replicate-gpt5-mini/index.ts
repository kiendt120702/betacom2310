...
serve(async (req) => {
  ...
  try {
    ...
    const { prompt, system_prompt, reasoning_effort, max_completion_tokens, conversation_history, image_url } = requestBody;
    
    let finalPrompt = prompt;

    // FIX: If an image is provided without a text prompt, use a default prompt.
